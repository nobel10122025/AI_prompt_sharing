  ...
  return (
    <section className='w-full max-w-full flex-start flex-col'>
      ...
      <p className="desc text-left max-w-mid">
        {type} and share amazing propmt with the world, and let your imagination run wild with the any AI-powered platform
      </p>
      <form
      ...
      >
        ...
        <label>
          <span className='font-satoshi font-semibold text-base text-gray-700'>
            Tag {` `}
            <span className='font-normal'>(#product, #webdev, #frontend)</span>
          </span>
          <input
            value={post.tag}
